...
export function App(props) {
  ...
  const handleSelectedOptionsChange = (
    ...
    switch (action) {
      case "remove-value":
        ...
        getViz(allPlotConfigs, rightNavMetadataStateObj);
  ...
  useEffect(() => {
    console.log({ selectedOptions }, { allPlotConfigs }, {rightNavMetadataStateObj});
  });
  ...
  window.addEventListener(
    "resize",    
    debounceLeading(() => getViz(allPlotConfigs, rightNavMetadataStateObj), 1000)
  );
  ...
  return (
    ...
    >
        <Drawers
          ...
          rightNav={<DataTable rightNavStateObj={rightNavStateObj} data={rightNavMetadataStateObj[0]}></DataTable>}
          content={
            <>
