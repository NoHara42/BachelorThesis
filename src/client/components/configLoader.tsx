...
import { requestHeaders, requestRangeNumberValuesOfColumn } from "..";
import { GlobalContext } from "../app";
import { CheckBox, DropDown, NumberInput } from "./exports";
...
export default function ConfigLoader(props) {
  ...
  useEffect(() => {
    (async () => {
      setOptionsCache(await requestHeaders({tableName: props.tableName, includeFunc, excludeFunc}));
    })();
  }, []);
